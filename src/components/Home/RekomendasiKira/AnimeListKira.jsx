...
const AnimeListKira = ({ animeList }) => {
    ...
    return (
        <div>
            ...
            <div className="anime-list grid grid-cols-2 mx-6 ">
                <div className=''>
                    <Link href={selectedAnime.link}>
                    <img src={selectedAnime.landscapeImage} alt={selectedAnime.name} className='h-[60vh] max-lg:h-[30vh] max-xl:h-[30] max-2xl:h-[45vh] rounded hover:opacity-60' />
                ...
                <div className="anime-cards grid grid-cols-4 gap-x-2 gap-y-5 lg:ml-4 px-10">
                    {animeList.map((anime) => (
