...
const HeaderKeyword = ({ title, linkHref, linkTitle }) => {
  return (
    <div>
      <div className='flex items-center h-52 bgKeqing mb-20 text-center justify-center'>
        <div className="flex backgroundTransparan2 h-64 items-center justify-center">
          <h1 className='max-md:text-xl text-2xl font-bold text-white text-center '>{title}</h1>
          {
            linkHref && linkTitle
              ?
